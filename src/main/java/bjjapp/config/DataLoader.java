...
public class DataLoader implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                if (schoolRepository.count() < 5) {
                        ...
                        // School in TRIAL
                        SchoolOwner owner1 = schoolOwnerRepository.findByEmail("joao@email.com")
                                        .orElseGet(() -> schoolOwnerRepository.save(SchoolOwner.builder()
                                                        .fullName("João Silva")
                        ...
                        School school1 = schoolRepository.findBySlugAndDeletedAtIsNull("gracie-barra-centro")
                                        .orElse(null);
                        if (school1 == null) {
                        ...
                        // School ACTIVE
                        SchoolOwner owner2 = schoolOwnerRepository.findByEmail("maria@email.com")
                                        .orElseGet(() -> schoolOwnerRepository.save(SchoolOwner.builder()
                        ...
                        School school2 = schoolRepository.findBySlugAndDeletedAtIsNull("instituto-jiu-jitsu")
                                        .orElse(null);
                        if (school2 == null) {
                        ...
                        // School INACTIVE
                        SchoolOwner owner3 = schoolOwnerRepository.findByEmail("pedro@email.com")
                                        .orElseGet(() -> schoolOwnerRepository.save(SchoolOwner.builder()
                                                        .fullName("Pedro Lima")
                        ...
                        School school3 = schoolRepository.findBySlugAndDeletedAtIsNull("centro-treinamento-bjj")
                                        .orElse(null);
                        if (school3 == null) {
                        ...
                        // School PAST_DUE
                        SchoolOwner owner4 = schoolOwnerRepository.findByEmail("ana@email.com")
                                        .orElseGet(() -> schoolOwnerRepository.save(SchoolOwner.builder()
                        ...
                        School school4 = schoolRepository.findBySlugAndDeletedAtIsNull("escola-artes-marciais")
                                        .orElse(null);
                        if (school4 == null) {
                                ...
                                school4 = School.builder()
                                                ...
                                                .subscription(sub4)
                                                .build();
                                school4 = schoolRepository.save(school4);
                        ...
                        log.info("Dados de exemplo para schools verificados/criados");
                }
